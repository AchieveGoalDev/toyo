...
const 西野: TestimonialProfile = {
  ...
  major: "経営学部２年",
  quote: "この講座を受けて、スピーキングが一番大事ということをさらに確信しました。",
  fullQuote: [
...
const 池田: TestimonialProfile = {
  ...
  major: "国際観光学部２年",
  quote: "英語の発音の仕方や応用の仕方、プレゼンの仕方までたくさんのことを学ぶことができます。",
  fullQuote: [
...
const 内島: TestimonialProfile = {
  ...
  major: "経済学部３年",
  quote: "先生は、いつも笑顔で明るくて、ミスを恐れず発言できる環境を作ってくれました。",
  fullQuote: [
...
const 関口: TestimonialProfile = {
  ...
  quote: "フレンドリーな先生を中心に生徒同士も仲良くなれるので、恥ずかしがらずに会話できます。",
  fullQuote: [

...
export const special: Collection[] = [
  {
    ...
    questions: [
      {
        q: "英会話初心者ですが受講できますか。",
        a: "みんな英語を始めるときは初心者です。まずは英語を好きになってもらうことを目的に、クラスメイトと楽しく学べるレッスンを行っていますので、ご心配はいりません。担当する講師は、親しみやすい講師になりますので楽しく英会話を学ぶことが出来ます！",
      },
      {
        q: "授業内容について",
      ...
      {
        q: "レッスン中に日本語を使いますか？",
        a: `English Only Policy（日本語禁止）の環境で、全て英語でレッスンを行います。講師は、英語で話し掛けますが、身振り手振り、表情で自然にその英語を理解できるようになります。`,
      },
      {
        q: "レッスン以外に予習や復習は必要ですか。",
        a: `予習と復習を両方していただくことをお薦めしておりますが、お忙しくて時間がとれない場合は、予習より復習することを心掛けて下さい。
        その日習った内容を繰り返し、復習することで知識の定着につながります。`,
      },
      {
        q: "学内講座の場合、単位認定はされますか？",
        a: "単位認定はできません。東洋大学内での英話講座ですが、課外授業となります。",
      },
      {
        q: "学内講座の場合、学部は関係ありますか？",
        a: `全学部・全学年対象にキャンパス内留学「Toyo Achieve English」を提供します。違う学年・学部の受講生とレッスンを受講いただきますので新しい英会話を学習する仲間と巡り合うことが出来ます。`,
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: `講師はどこの国の人ですか？`,
        a: `フィリピン人講師が担当致します。フィリピンは英語を公用語とし、英会話講師として最低3年以上の経験を積んだ講師及び英語教育資格を持った講師が担当致します。`,
      },
      {
        q: `講師は毎回変わるのですか？`,
        a: `英会話講座期間中は同じ講師が担当致します。
    ...
    questions: [
      {
        ...
        a: `ウェブ上にて、募集をかけている期間と時間割のみの開講となります。`,
      },
      {
        q: `開講期間の全ての講座を受講することが出来ません。
        それでもお申込みは出来ますか。`,
        a: `受講することは可能ですが、グループレッスンの場合他の受講生に進捗を合わせて頂きます。
        また、受講料は講座を出席できる日数に関わらず、全額お振込み頂く必要がございます。`,
      },
      {
        q: `欠席をした際、レッスンの振替はありますか。`,
        a: `春期・夏期特別講座の場合、振替授業はございませんので、ご参加できる期間にてお申し込みください。
        英会話講座～通年コース～の場合は、前日までにご連絡を頂ければ振替可能です。`,
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: `お支払い手順を教えてください。`,
        a: `① 本メール受信後、7日以内に下記メールアドレスより支払方法の案内をお送りいたします。
        送信元メールアドレス：payment@tugs.co.jp
        ※迷惑メールに入らない様、登録をお願いいたします。
        ② 支払案内メール受領後、5日以内に下記URLの手順に沿ってお支払いをお願いいたします。
        http://u0u0.net/VCGs
        ③ 受講料のお振込み先は東洋大学様指定の銀行口座の為、
        着金確認に2~3営業日いただいておりますので、受講がスムーズに開始できるよう支払い完了後、支払いが確認できる振込明細書等を本メールへ写真添付しご連絡いただきますようお願いいたします。
        ④ 着金確認後、受講が可能となります。`,
      },
      {
        q: `受講料の分割はできますか。途中でやめることはできますか。`,
        a: `受講料は一括でお支払いいただきます。いかなる理由があってもお申込みの返金をすることが出来ません。諸事情によって受講が困難な場合は、サポートデスクにご相談ください。`,
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: `本講座の運営はどちらですか？`,
        a: `本講座は東洋大学グローバルサービス株式会社と株式会社アチーブゴールが提携して運営をしております。
        株式会社アチーブゴールとは、国内外の留学支援事業、英語講師派遣事業、英語レッスン提供事業を行っている企業です。フィリピン・セブ島にて留学生のサポート体制を整え、フィリピン留学最大手SMEAG校を運営からスタートしました。
        短期間でハイレベルな英語力をマスターできるメソッドを構築し、その実績に基づくカリキュラムレベルを当社運営のSMEAG校にて展開。
        現地でのプログラムのほとんどをマンツーマンで行い、英語で学ぶ力をつけることが出来ます。レベルの高い講師が、東洋大学キャンパス内で英会話講座を開講！
        (株)アチーブゴール
  ...
  },
  {
    ...
    questions: [
      {
        q: `レッスンはどこで行われますか。`,
        a: `東洋大学の各キャンパスにて対面、もしくはオンラインにて行われます。
        開講する講座により異なりますので、ご不明な場合はサポートデスクまでご連絡下さい。

import { type TextInputParams, type RadioInputParams, type ImageSelectChoiceParams, DoubleTextInput } from "$lib/forms/data/typeDefs";
import { RadioInput, SingleTextInput, SubformData, ImageSelectChoice, ImageSelectInput } from "$lib/forms/data/typeDefs"
import { validate英字名, validate学籍番号, validateフリガナデータ, validateIsRequired, validateVoid, validateSchoolEmail, validatePersonalEmail } from "$lib/forms/data/validatorDefs"
